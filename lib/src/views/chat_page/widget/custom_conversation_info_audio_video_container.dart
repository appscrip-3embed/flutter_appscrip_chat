...
class IsmChatConversationInfoAudioVideoContainer extends StatelessWidget {
   IsmChatConversationInfoAudioVideoContainer({Key? key,required this.title, required this.pictureName}) : super(key: key);
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        Icon(pictureName, color: IsmChatConfig.chatTheme.primaryColor,),
        Text(title ?? '', style: TextStyle(color: IsmChatConfig.chatTheme.primaryColor)),
      ],
    ),
  );
}
