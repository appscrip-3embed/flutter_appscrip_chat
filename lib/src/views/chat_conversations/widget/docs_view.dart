...
class _IsmDocsViewState extends State<IsmDocsView> with TickerProviderStateMixin {
  ...
  void initState(){
    ...
    storeWidgetDocsList =  chatPageController.sortMediaList(storeSortDocs);
    super.initState();
  }
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              value[valueIndex].attachments?.first.name ?? '',
